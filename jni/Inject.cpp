...
const char *pkgName = "no.mobitroll.kahoot.android";
const char *appLaunchActivity = "no.mobitroll.kahoot.android/no.mobitroll.kahoot.android.application.SplashActivity";
const char *libraryPath = "/data/local/tmp/libHook.so";
pid_t pid = 0;
...
int main(int argc, char const *argv[]) {
    ...
    LOGI("Package Name: %s", pkgName);
    LOGI("Library Path: %s", libraryPath);
